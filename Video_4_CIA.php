...
<body>
    ...
    <div class="container">
        <div class="video-container">
            <h2>4. Identificación de Ritmos Anormales</h2>
            <video controls>
        ...
        <div class="content-container">
            <div class="temario">
                ...
                <ul>
                    <strong>4. Identificación de Ritmos Anormales</strong>
                    <ul>
                        <li>Taquiarritmias: causas, características y diagnóstico diferencial</li>
                        <li>radiarritmias: tipos, manifestaciones clínicas y abordaje terapéutico</li>
                        <li>Arritmias supraventriculares y ventriculares: reconocimiento y tratamiento</li>
                    </ul>
    ...
    <script>
        ...
        function nextVideo() {
            ...
            if (answer.trim() === '') {
                ...
                window.location.href = 'Video_5_CIA.php'; // Cambia "video2.php" por la URL del siguiente video
            }
        }
