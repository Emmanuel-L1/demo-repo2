...
<body>
    ...
    <div class="container">
        <div class="video-container">
            <h2>2. Bases Electrocardiográficas</h2>
            <video controls>
        ...
        <div class="content-container">
            <div class="temario">
                ...
                <ul>
                    <strong>2. Bases Electrocardiográficas</strong>
                    <ul>
                        <li>Principios físicos detrás de la formación del ECG</li>
                        <li>Derivaciones y posicionamiento de electrodos</li>
                        <li>Ciclo cardíaco: despolarización y repolarización</li>
                        <li>Conceptos clave: ondas P, QRS, y T en el ECG</li>
                    </ul>
    ...
    <script>
        ...
        function nextVideo() {
            ...
            if (answer.trim() === '') {
                ...
                window.location.href = 'Video_3_CIA.php'; // Cambia "video2.php" por la URL del siguiente video
            }
        }
