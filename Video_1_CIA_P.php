...
<body>
    ...
    <div class="container">
        <div class="video-container">
            <h2>1. Anatomia Básica del corazón</h2>
            <video controls>
        ...
        <div class="content-container">
            <div class="temario">
                ...
                <ul>
                    <strong>1. Anatomía Básica del Corazón</strong>
                    <ul>
                        <li>Estructura anatómica del corazón</li>
                        <li>Circulación coronaria y vascularización</li>
                        <li>Cámaras cardíacas y su función</li>
                        <li>Valvas cardíacas y su importancia en el ciclo cardíaco</li>
                    </ul>
            ...
            <div class="btn-group">
                ...
                <button id="nextBtn" class="btn" onclick="nextVideo()">Finalizar Vista Previa</button>
    ...
    <script>
        ...
        function nextVideo() {
            ...
            if (answer.trim() === '') {
                ...
                window.location.href = 'Inmunologia_Avanzada_Curso.php'; // Cambia "video2.php" por la URL del siguiente video
            }
        }
