...
<body>
    ...
    <div class="container">
        <div class="video-container">
            <h2>5. Taller de Identificación de Ritmos</h2>
            <video controls>
        ...
        <div class="content-container">
            <div class="temario">
                ...
                <ul>
                    <strong>5. Taller de Identificación de Ritmos</strong>
                    <ul>
                        <li>Casos clínicos prácticos y simulaciones de ECG</li>
                        <li>Sesiones interactivas de interpretación de ritmos cardíacos</li>
                        <li>Análisis y discusión de casos reales para fortalecer habilidades prácticas</li>
                    </ul>
            ...
            <div class="btn-group">
                ...
                <button id="nextBtn" class="btn" onclick="nextVideo()">Finalizar curso</button>
    ...
    <script>
        ...
        function checkAnswer() {
            ...
            if (answer.trim() === '') {
                ...
                showMessage('Respuesta correcta. Puedes avanzar a obtener tu certificado.', 'success-message', 'nextVideoMessage');
        ...
        function nextVideo() {
            ...
            if (answer.trim() === '') {
                ...
                window.location.href = 'Certificado.php'; // Cambia "video2.php" por la URL del siguiente video
            }
        }
